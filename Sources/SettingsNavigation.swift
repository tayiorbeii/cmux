...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.terminal, "tmux-aware-navigation", String(localized: "settings.terminal.tmuxAwarePaneNavigation", defaultValue: "tmux-Aware Pane Navigation"), "terminal.tmuxAwarePaneNavigation tmux pane navigation option h j k l edge split focus"),
